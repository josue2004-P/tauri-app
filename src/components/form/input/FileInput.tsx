...
export default function FileInput({ id, className = "", disabled = false, onChange }: FileInputProps) {
  return (
    <input
      id={id}
      type="file"
      disabled={disabled}
      accept="image/*" // Restringe nativamente la ventana de selección a solo imágenes
